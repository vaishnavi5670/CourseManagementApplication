...
{ 
    public class StudentEnrollmentsController : Controller
    {
        ...
        public StudentEnrollmentsController(CourseManagementAppDbContext context)
        {
            _context = context;
        }
        ...
        {
            var courseManagementAppDbContext = _context.StudentEnrollments.Include(s => s.Course).Include(s => s.Student);
            return View(await courseManagementAppDbContext.ToListAsync());
        }
        ...
        public async Task<IActionResult> Create([Bind("EnrollmentId,StudentId,CourseId,EnrolledOn,Status,Grade")] StudentEnrollment studentEnrollment)
        {
            ...
            ViewData["CourseId"] = new SelectList(_context.Courses, "CourseId", "Title", studentEnrollment.CourseId);
            ViewData["StudentId"] = new SelectList(_context.Students, "StudentId", "Email", studentEnrollment.StudentId);
            return View(studentEnrollment);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("EnrollmentId,StudentId,CourseId,EnrolledOn,Status,Grade")] StudentEnrollment studentEnrollment)
        {
